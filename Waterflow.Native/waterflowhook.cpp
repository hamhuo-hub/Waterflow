...
// Thereshold
const int THROTTLE_MS = 10;

const int DRAG_THRESHOLD = 15;

const int MAX_GESTURE_DELAY = 300;
...
static DWORD g_lastMoveTime = 0;
static DWORD g_rightDownTime = 0;
...
LRESULT CALLBACK LowLevelMouseProc(int nCode, WPARAM wParam, LPARAM lParam) {
	if (nCode == HC_ACTION) {
		...
		case WM_RBUTTONDOWN:
			...
			g_rightDownTime = GetTickCount(); // start time
			g_lastMoveTime = 0;
